...
"
WINDOW_CURRENT="\
#[fg=$COLOR0,bg=$COLOR2,nobold,nounderscore,noitalics]$RIGHTARROW\
#[fg=$COLOR0,bg=$COLOR2,nobold,nounderscore,noitalics] #I: #W \
#[fg=$COLOR2,bg=$COLOR0,nobold,nounderscore,noitalics]$RIGHTARROW\
"
LOCAL_DATETIME="\
#[fg=$COLOR2,bg=$COLOR0,nobold,nounderscore,noitalics]$LEFTARROW\
#[fg=$COLOR0,bg=$COLOR2] %Y-%m-%d \
#[fg=$COLOR0,bg=$COLOR2,nobold,nounderscore,noitalics]$LEFTARROW\
...
#[fg=$COLOR0,bg=$COLOR0,nobold,nounderscore,noitalics] \
"
